...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["README.rdoc", "lib/controller/params.rb", "lib/webs.rb"]
  s.files = ["README.rdoc", "Rakefile", "lib/controller/params.rb", "lib/webs.rb", "webs.gemspec", "Manifest"]
